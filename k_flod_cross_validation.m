...
function [accuracy]=calculate_acc(floder_test_feature, floder_test_image_num, train_feature, train_num)
    ...
    for test_i = 1:length(floder_test_feature)
        ...
        [result,v]=BayesErzhishuju(i_feature, train_feature, train_num);
        if label_i == result
